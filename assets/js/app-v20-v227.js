...
const V1822_CACHE_VERSION='22.7-20260803-stable';
...
/* Ver.20 stable boot */
window.V20_BUILD = "22.7-20260803-stable";
async function v20SafeBoot(){try{if('serviceWorker' in navigator){for(const r of await navigator.serviceWorker.getRegistrations()) await r.unregister();} if('caches' in window){for(const k of await caches.keys()) await caches.delete(k);} localStorage.setItem('furugen_v20_build','22.7-20260803-stable');}catch(e){console.warn('V22.7 cleanup:',e);}}
