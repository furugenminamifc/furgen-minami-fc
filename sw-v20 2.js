const CACHE='furugen-v22-22.4-20260802';
const BUILD='22.4-20260802';
const CORE=['./','./index.html?build='+BUILD,'./manifest.webmanifest?build='+BUILD,'./assets/css/app-v20.css','./assets/js/app-v20.js','./assets/css/live-match-v224.css?build='+BUILD,'./assets/js/live-match-v224.js?build='+BUILD];
