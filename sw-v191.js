const CACHE_NAME='furugen-ai-coach-v19.1.0';
const CORE=['./','./index.html?v=19.1.0','./config.js?v=19.1.0','./manifest.webmanifest?v=19.1.0','./assets/css/app.css?v=19.1.0','./assets/js/app.js?v=19.1.0','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
